...
// var weather = [];
// myHttp.open("GET","https://api.weatherapi.com/v1/forecast.json?key=72beb792947646c9b67135146222101&q=egypt&days=3");
// myHttp.send();
// myHttp.addEventListener("readystatechange",function(){
//     if(myHttp.readyState == 4 && myHttp.status == 200){
//          weather =JSON.parse(myHttp.response).forecast.forecastday;
//          console.log(weather);
//          dispalyWeather();
//     }
// })
...
//         border-light">${weather[i].date}</div>
//       <div class="card-body bg-card ">
//         <h5 class="card-title">Cairo</h5>
//         <div><img src="${weather[i].day.condition.icon == null ?'img/img/sunny.png': weather[i].day.condition.icon}"></div>
//         <h3 class="card-text">${weather[i].maxtemp_c}<sup>o</sup>C</h3>
//         <p class="card-text"><small class="text-primary">${weather[i].day.condition.text}</small></p>
//         <span><img src="img/routeegypt_com/icon-umberella.png">${weather[i].day.daily_chance_of_rain}%</span>
//         <span><img src="img/routeegypt_com/icon-wind.png">${weather[i].day.maxwind_kph}km/h</span>
